...
public class EmailService {
	 ...
	 */
	@ServiceActivator()
	public MimeMessage handle(RouteOrder order) throws MessagingException {
		// Need to use your own recipient here
		String recipientEmail = "ulziierdene121@gmail.com";
		String recipientName = "Ulzii";
		return handle(recipientName, recipientEmail, order, null);
	}

	public MimeMessage handle(final String recipientName, final String recipientEmail, RouteOrder order, Locale locale)
